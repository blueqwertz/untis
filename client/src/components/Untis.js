...
function Untis() {
	...
	const [dataOptions, setDataOptions] = useState(localStorage.getItem("dataOptions") ? loadDataOptions() : { id: 1790, type: "group", name: "7DD", date: new Date().toISOString().slice(0, 10), before: {}, searchFavourites: [] })
